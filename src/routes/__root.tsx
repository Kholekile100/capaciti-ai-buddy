...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CAPACITI Worksmart AI" },
      {
        name: "description",
        content:
          "CAPACITI Worksmart AI is an AI workplace productivity assistant for summaries, emails, action items and planning.",
      },
      { name: "author", content: "CAPACITI" },
      { property: "og:title", content: "CAPACITI Worksmart AI" },
      {
        property: "og:description",
        content: "An AI workplace productivity assistant for busy teams.",
      },
